        ...
        <div class="modal-content">
            <form id="addEventForm" class="form-horizontal" method="POST" >
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Appointment Add</h5>
                ...
                <div class="modal-body row ">
                   ...
                   <div class="col-lg-6">
                    ...
                    <button id="maintenanceEye" type="button" class="btn btn-sm btn-outline-secondary rounded-pill btn-block col-lg-4 col-4 offset-4 offset-lg-4 text-lg-center"><i class="fa fa-angle-down"></i> Choose Maintenance</button>
                    <div id="maintenance" style="display: none;" class="form-group btn-group-sm mt-2 col-lg-10 col-10 offset-1 offset-lg-1  ">
                        ...
                        <table id="maintenanceTable" style="border-radius: 1rem; !important;" class="table table-responsive-lg table-borderless  btn-sm shadow-main">
                            <tr> <td class="col-lg-1 col-1 offset-3 offset-lg-3">  <button id="maintenanceAdd" type="button" class=" btn btn-success btn-sm small-btn-size fa fa-plus " data-toggle="popover"  data-content="
                            Double-click if you want to add maintenance type" data-placement="bottom" data-trigger="focus" title="Maintenance Add"  ></button>
                                </td>
                                <td class="col-lg-1 col-1 offset-2 offset-lg-2">    <button id="maintenanceEdit" type="button" class=" btn btn-info  btn-sm small-btn-size fa fa-pencil "  data-toggle="popover"  data-content="
                             If you want to edit the type of maintenance. Select from the side and double-click" data-placement="bottom" data-trigger="focus" title="Maintenance Edit"></button>
                                ...
                                <td class="col-lg-1 col-1 offset-2 offset-lg-2">  <button id="maintenanceDelete" type="button" class=" btn btn-danger btn-sm small-btn-size fa fa-trash "  data-toggle="popover"  data-content="
